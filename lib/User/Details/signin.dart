...
import 'package:kings_dharbar1/User/Accountinfo/forgotpassword.dart';
import 'package:kings_dharbar1/User/Details/responsive_ui.dart';
import 'package:kings_dharbar1/User/Details/signup.dart';
...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            "Forgot Password?",
            style: TextStyle(fontWeight: FontWeight.w400,color:Colors.grey[400],fontSize: _large? 14: (_medium? 12: 10)),
          ),
          SizedBox(
            width: 5,
          ),
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => Forgotpassword(_email!)));
            },
            child: Text(
              "Recover",
              style: TextStyle(
  ...
  Widget button() {
    return RaisedButton(
      ...
      child: Container(
        ...
        child: Text("Login Here",style: TextStyle(fontSize: _large? 14: (_medium? 12: 10))),
      ),
    );
  }
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "SignUp Here",
              style: TextStyle(
                  fontWeight: FontWeight.w800, color: Colors.red, fontSize: _large? 19: (_medium? 17: 15)),
            ),
          )
        ],
      ),
  ...
  _buildUserEmail() {
    return TextFormField(
        ...
        decoration: _buildInputDecoration(Icon(Icons.email,color: Color(0xFF3F3C3D)),"Email-Id"),
        onChanged: (value) {
          setState(() {
            _email = value.trim();
          });}
  ...
  _buildUserPassword() {
    return TextFormField(
        ...
        style: TextStyle(
            color: Color(0xFF3F3C3D), fontFamily: 'RadikalLight'),
        decoration:
        _buildInputDecoration(Icon(Icons.lock,color: Color(0xFF3F3C3D)),"Password"),
        onChanged: (value) {
          setState(() {
